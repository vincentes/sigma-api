...
foreign key(Id_Usr_Alumno) references USUARIO(Id_Usr),
...
foreign key(Id_Usr_Docente) references USUARIO(Id_Usr),
...
foreign key(Id_Usr_Adscripto) references USUARIO(Id_Usr),
...
foreign key(Id_Usr_Admin) references USUARIO(Id_Usr),
);
GO
